### Pitcher Aging Factors

sp_aging_factors <- function(){

  library(dplyr)
  library(XML)

  raw.data <- readHTMLTable("http://www.fangraphs.com/leaders.aspx?pos=all&stats=sta&lg=all&qual=y&type=c,3,6,14,19,20,21,24,48,49,120,121&season=2014&month=0&season1=2003&ind=1&team=0&rost=0&age=0&filter=&players=0&page=1_1500", stringsAsFactors = FALSE)$LeaderBoard1_dg1_ctl00
  for (i in c(1:2,5:11)){
